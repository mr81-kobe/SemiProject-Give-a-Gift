...
<br />
	...
	<form  action="search" method="get" >			
		...
		<td colspan="5" style="border: white; text-align: right;"></td>	
	 	<input type="submit" class="btn btn-success" value="검색"/><br />	 	
	 	</form>
		</div>
	...
	<table class="table table-striped table-hover">
		...
		<tr class="row100 body">
				...
				<td class="cell100 column2"><a href="detail_nh?no=${n.no }">${n.title }</a></td>
	...
	<a href="nh_board/writeForm.jsp" ><button type="button" class="btn btn-success" >글쓰기</button></a>	
