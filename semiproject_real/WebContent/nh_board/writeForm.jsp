...
<div class="row column1" style="margin-bottom: 50px;">
 ...
 <form action="../write" method="post">
	<table class="table table-hover">
		<tr align="center">
		<th colspan="2">글쓰기 화면</th></tr>
		<tr>
			<td>제목</td>
			<td><input type="text" name="title" required="required" size="48" maxlength="30" class="form-check-input mt-0"/></td>
		</tr>
		<tr>
			<td>내용</td>
			<td><textarea rows="10" cols="48" name="content" required="required" maxlength="300" class="form-control"></textarea><td>
		</tr>
		<tr>
			
			<input type="hidden" name="writer" required="required" maxlength="25"  class="form-check-input mt-0"   value="${userid}"/>
		</tr>
		<tr align="center">
			<td colspan="2">
			<input type="submit" value="저장" class="btn btn-primary" />
			<input type="button" value="취소" onclick="location.href='../list_nh'" class="btn btn-primary" />
			</td>
		</tr>
	</table>
	</form>
