...
<div class="row column1" style="margin-bottom: 50px;">
 ...
 <div id="container" align="center">
		...
		<div id="form_box" style="width: 700px;">
...
<span class="input-group-text" id="inputGroup-sizing-default">startDate</span>
  <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" id="startDate" name="startDate">
 ...
 금
  ...
  <label class="form-check-label" for="flexCheckDefault">
    일
					...
					<div class="form-check">
					1교시<input type="radio" name="class"
						value="T09:00:00~T12:00:00"> 2교시<input type="radio"
						name="class" value="T13:00:00~T16:00:00"> 3교시<input
						type="radio" name="class" value="T16:00:00~T19:00:00">
</div>
					<div class="form-check">
					...
					<input type="submit" value="날짜지정" class="btn btn-primary">
