...
<button type="button" class="btn btn-primary"  onclick="location.href='kakao?command=mypage'">MyPage</button>
</c:if>
<c:if test="${tag eq 'none' }">

<button type="button" class="btn btn-primary"  onclick="location.href='kakao?command=mypageForStudent'">MyPage</button>
</c:if>
<br/>
