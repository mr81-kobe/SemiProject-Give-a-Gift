              ...
              <nav class="navbar navbar-expand-lg navbar-light ">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                      <a class="nav-link headerachor" href="#">Mojip</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link headerachor" href="#">QnA</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link headerachor" href="#">Report</a>
                    </li>
...
<div class="row column1">
	...
	<a href="javascript:kakaoLogin();"><img class="kakao_img"
		src="https://img1.daumcdn.net/thumb/R720x0.q80/?scode=mtistory2&fname=http%3A%2F%2Fcfile28.uf.tistory.com%2Fimage%2F99BEE8465C3D7D12140EAC"></a>
	...
	<script type="text/javascript" src="Member/script/script.js"></script>
</div>
