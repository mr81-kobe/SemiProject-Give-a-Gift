 ...
 <div align="center" >
	...
	<div class="limiter">
		...
		<tr class="row100 head">
			...
			<th class="cell100 column3">날짜</th>
		...
		<c:forEach var="n" items="${list }">
			<tr class="row100 body">
				<td class="cell100 column1">${n.code }</td>
				<td class="cell100 column2">
					<a href="passwordcheck?code=${n.code }">
						${n.title }
					</a>
				</td>
				<td class="cell100 column3"><fmt:formatDate pattern="yyyy-MM-dd" value="${n.rdate }" /></td>
				<td class="cell100 column4">${n.hit }</td>
			</tr>
		</c:forEach>
		</table>
	</div>
	...
	<a href="http://localhost:8081/semiproject_real/report/writeForm.jsp">글쓰기</a>
	<br>
	<br>
