 ...
 <div align="center" >
	...
	<table class="table table-hover">
		<tr>
			...
			<td class="column2">${dto.code }</td>
		</tr>
		<tr>
			<th class="column1">제목</th>
			<td class="column2"><input type="text" readonly="readonly" value="${dto.title }"></td>
		</tr>
		<tr>
			<th class="column1">내용</th>
			<td class="column3"><textarea rows="12" cols="35"  class="form-control" readonly="readonly">${dto.content }</textarea></td>			
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="column2"><fmt:formatDate pattern="yyyy-MM-dd hh:mm:ss" value="${dto.rdate }" /></td>
		</tr>
		<tr>
			...
			<input type="button" value="수정" onclick="location.href='update_in?code=${dto.code}'" class="btn btn-primary"/>
			<input type="button" value="삭제" onclick="location.href='delete_in?code=${dto.code}'" class="btn btn-primary"/>
			<input type="button" value="답글달기" onclick="location.href='report/replyForm.jsp?code=${dto.code}&title=${dto.title }'"  class="btn btn-primary"/>
			<input type="button" value="목록" onclick="location.href='list_in'" class="btn btn-primary"/>
</div>
