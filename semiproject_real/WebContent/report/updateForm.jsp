...
<div class="row column1" style="margin-bottom: 50px;">
 ...
 <div align="center" >
	...
	글 수정
	<form action="update_in" method="post">
	...
	<table class="table table-hover">
		<tr>
			...
			<td class="column2"><input type="text" name="code" class="form-control" id="form-control2" value="${dto.code }" readonly="readonly" /></td>
		</tr>
		<tr>
			<th class="column1">제목</th>
			<td class="column2"><input type="text" name="title" class="form-control" value="${dto.title }" /></td>
		</tr>
		<tr>
			<th class="column1">내용</th>
			<td class="column3"><textarea rows="10" class="form-control" name="content" >${dto.content }</textarea></td>
		</tr>
		<tr>
			<th class="column1">글 비밀번호</th>
			<td class="column2"><input type="text" name="password" class="form-control" id="form-control2" value="${dto.password }" /></td>
		</tr>
		<tr>
